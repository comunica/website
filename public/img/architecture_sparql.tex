...
\begin{tikzpicture}[
	...
	% Init
	\node[actor] (init) {Comunica SPARQL};
	
	\node[bus,below=of init] (bus-query-operation) {Query Operation};
	...
	\node[bus,right=7 of bus-query-operation] (bus-sparql-serialize) {SPARQL Serialize};
	
	\draw[->,thick](init.south) -- (bus-query-operation.north);
	\draw[->,thick](init.south) -- (bus-optimize-query-operation.north);
	\draw[->,thick](init.south) -- (bus-sparql-parse.north);
	\draw[->,thick](init.south) -- (bus-context-preprocess.north);
	\draw[->,thick](init.south) -- (bus-sparql-serialize.north);
	...
	\node[bus,right=of bus-rdf-resolve-hypermedia-links] (bus-rdf-resolve-hypermedia) {RDF Resolve Hypermedia};
