...
\begin{tikzpicture}[
    ...
    % Query Process
    \node[bus,below=1 of actor-init-query] (bus-query-process) {Query Process};
    \draw[->,thick](actor-init-query.south) -- (bus-query-process.north);
    \node[actor,below=1 of bus-query-process] (actor-query-process-sequential) {Sequential};
    \draw[->,thick](bus-query-process.south) -- (actor-query-process-sequential.north);

    \node[bus,below=of actor-query-process-sequential] (bus-query-operation) {Query Operation};
    ...
    \draw[->,thick](actor-query-process-sequential.south) -- (bus-query-operation.north);
	\draw[->,thick](actor-query-process-sequential.south) -- (bus-optimize-query-operation.north);
	\draw[->,thick](actor-query-process-sequential.south) -- (bus-query-parse.north);
	\draw[->,thick](actor-query-process-sequential.south) -- (bus-context-preprocess.north);

	\node[bus,right=18 of bus-query-process] (bus-query-serialize) {Query Serialize};
    \draw[->,thick](actor-init-query.south) -- (bus-query-serialize.north);

    % Context Preprocess
    \node[actor,below=1 of bus-context-preprocess] (actor-context-preprocess-query-source-identify) {Query Source Identify};
	\draw[->,thick](bus-context-preprocess.south) -- (actor-context-preprocess-query-source-identify.north);
	...
	\node[actor,below=1 of bus-optimize-query-operation] (actor-optimize-query-operation-join-bgp) {Join BGP};
	...
	\node[bus,below=1 of actor-context-preprocess-query-source-identify] (bus-query-source-identify) {Query Source Identify};
	\draw[->,thick](actor-context-preprocess-query-source-identify.south) -- (bus-query-source-identify.north);

	\node[actor,below=of bus-query-source-identify] (actor-query-source-identify-serialized) {Serialized};
	\node[actor,right=of actor-query-source-identify-serialized] (actor-query-source-identify-hypermedia) {Hypermedia};
	\node[actor,left=of actor-query-source-identify-serialized] (actor-query-source-identify-rdfjs) {RDF/JS};
	\draw[<->,thick](bus-query-source-identify) -- (actor-query-source-identify-serialized.north);
	\draw[->,thick](bus-query-source-identify) -- (actor-query-source-identify-rdfjs.north);
	\draw[->,thick](bus-query-source-identify) -- (actor-query-source-identify-hypermedia.north);

	% Query Source Identify Hypermedia
	\node[bus,below=of actor-query-source-identify-hypermedia] (bus-rdf-metadata-extract) {RDF Metadata Extract};
	...
	\node[bus,right=of bus-rdf-resolve-hypermedia-links-queue] (bus-query-source-identify-hypermedia) {Query Source Identify Hypermedia};
    \node[bus,right=of bus-query-source-identify-hypermedia] (bus-rdf-update-hypermedia) {RDF Update Hypermedia};

	\draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-rdf-metadata-extract.north);
	\draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-rdf-metadata.north);
	\draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-dereference-rdf.north);
	\draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-query-source-identify-hypermedia.north);
	\draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-rdf-resolve-hypermedia-links.north);
    \draw[->,thick](actor-query-source-identify-hypermedia.south) -- (bus-rdf-resolve-hypermedia-links-queue.north);
	...
	% Query Source Identify Hypermedia
	\node[actor,below=1 of bus-query-source-identify-hypermedia] (actor-query-source-identify-hypermedia-sparql) {SPARQL};
	\node[actor,left=1 of actor-query-source-identify-hypermedia-sparql] (actor-query-source-identify-hypermedia-none) {None};
	\node[actor,right=1 of actor-query-source-identify-hypermedia-sparql] (actor-query-source-identify-hypermedia-qpf) {QPF};
	\draw[->,thick](bus-query-source-identify-hypermedia) -- (actor-query-source-identify-hypermedia-sparql.north);
	\draw[->,thick](bus-query-source-identify-hypermedia) -- (actor-query-source-identify-hypermedia-none.north);
	\draw[->,thick](bus-query-source-identify-hypermedia) -- (actor-query-source-identify-hypermedia-qpf.north);
